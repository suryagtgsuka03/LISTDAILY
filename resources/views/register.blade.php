...
<body class="bg-gradient-to-r from-[#444444] to-[#3A3A3A] h-screen grid grid-cols-2 items-center font-Josefin">
    ...
    <div class="kanan flex justify-center text-[#DDDDDD] animate__animated animate__fadeIn">
        <div class="container w-[518px] h-[500px] bg-[#3A3A3A] p-4 shadow-[20px_20px_10px_#2B2B2B] rounded-[10px]">
            <h1 class="text-[36px] text-center mb-5">Register</h1>
            <div class="form p-7">
                <form class="space-y-[30px] w-full max-w-md mx-auto">
                    ...
                    <div class="email relative">
                        ...
                        <div
                            class="absolute left-0 top-0 flex items-center justify-center bg-[#DDDDDD] w-10 h-10 rounded-l-md">
                            <i data-feather="mail" class="text-black"></i>
                        </div>
                    </div>
                ...
                <div class="btn flex text-[12px] items-center mt-[50px]">
                    <p>Already Have One? <a href="/login" class="text-[#00F6FF] ">Click Here</a> To Login</p>
                    <a class="register w-[100px] h-[44px] bg-[#AAAAAA] text-[#3A3A3A] justify-center items-center flex rounded-[10px] ml-[110px] text-[16px]"
                        href="">
                        Create
                    </a>
                </div>
